    ...
    return (
        <section className="w-full py-20">
            ...
            <div className="my-20 flex flex-col lg:flex-row items-center justify-center gap-4">
                ...
                description="We plan and strategize the project to ensure the best possible outcome."
                >
                    <CanvasRevealEffect
                        animationSpeed={5.1}
                ...
                description="We design and develop the project to ensure the best possible outcome."
                >
                    <CanvasRevealEffect
                        animationSpeed={3}
